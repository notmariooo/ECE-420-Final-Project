...
HD_PWD='C:/Users/Mario/Downloads/week10_examples/idk_final/idk_final.runs/axi_perf_mon_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_perf_mon_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_perf_mon_0.tcl
